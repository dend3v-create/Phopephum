-- ============================================================================
-- Migration: 20260904000000_create_wisdom_memory.sql
-- Description: Step 4.1 Unified Wisdom Memory Layer (wisdom_queries + wisdom_outcomes)
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS public.wisdom_queries (
  ...
  intent_category   TEXT NOT NULL CHECK (intent_category IN ('timing', 'finance', 'relationship', 'lost', 'career', 'health', 'general')),
