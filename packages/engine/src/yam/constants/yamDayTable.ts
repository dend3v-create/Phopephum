...
export const yamDayTable: Record<DayName, string[]> = {
  sunday:    ["สุริชะ",  "ศุกระ",  "พุธะ",  "จันเทา", "เสารี",  "ครู",    "ภุมมะ",  "สุริชะ"],
  monday:    ["จันเทา",  "เสารี",  "ครู",    "ภุมมะ",  "สุริชะ", "ศุกระ",  "พุธะ",  "จันเทา"],
  tuesday:   ["ภุมมะ",   "สุริชะ", "ศุกระ",  "พุธะ",  "จันเทา", "เสารี",  "ครู",    "ภุมมะ"],
  wednesday: ["พุธะ",   "จันเทา", "เสารี",  "ครู",    "ภุมมะ",  "สุริชะ", "ศุกระ",  "พุธะ"],
  thursday:  ["ครู",     "ภุมมะ",  "สุริชะ", "ศุกระ",  "พุธะ",  "จันเทา", "เสารี",  "ครู"],
  friday:    ["ศุกระ",   "พุธะ",  "จันเทา", "เสารี",  "ครู",    "ภุมมะ",  "สุริชะ", "ศุกระ"],
  saturday:  ["เสารี",   "ครู",    "ภุมมะ",  "สุริชะ", "ศุกระ",  "พุธะ",  "จันเทา", "เสารี"],
};
