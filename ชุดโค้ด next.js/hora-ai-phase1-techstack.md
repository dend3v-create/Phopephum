...
NEXT_PUBLIC_AI_WORKER_URL=https://phopephum-proxy.workers.dev

# Cloudflare R2
R2_ACCESS_KEY_ID=...
R2_SECRET_ACCESS_KEY=...
R2_BUCKET_NAME=hora-reports
R2_PUBLIC_URL=https://cdn.phopephum.com

# Resend
RESEND_API_KEY=re_...
RESEND_FROM=noreply@phopephum.com
...
```bash
# 1. สร้าง Project
npx create-next-app@latest phopephum \
...
## Key Design Tokens (Phopephum Brand)
