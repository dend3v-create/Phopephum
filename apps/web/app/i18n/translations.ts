...
const horoscope = {
  th: {
    ...
    bases: {
      "1": "ฐาน วัน", "2": "ฐาน เดือน", "3": "ฐาน ปี",
      "4": "ฐานกำลัง", "5": "ฐาน ๕", "6": "ฐาน ๖",
      "7": "ฐาน ๗", "8": "ฐาน ๘", "9": "ฐาน ๙",
    },
    chart: {
...
const yam = {
  th: {
    ...
    yam_names: {
      "สุริชะ": "สุริชะ", "สุริยะ": "สุริยะ", "ระวิ": "ระวิ", "จันเทา": "จันเทา", "ศะศิ": "ศะศิ", "คะศิ": "คะศิ",
      "ภุมมะ": "ภุมมะ", "ภุมโม": "ภุมโม", "ภุมรา": "ภุมรา",
      "พุธะ": "พุธะ", "พุทธะ": "พุทธะ", "พุโธ": "พุโธ", "พุทโธ": "พุทโธ", "ทิวา": "ทิวา", "วาณี": "วาณี",
      "ครู": "ครู", "ชีโว": "ชีโว", "คุรุ": "คุรุ",
      "ศุกระ": "ศุกระ", "ศุโกร": "ศุโกร", "ภัสสะ": "ภัสสะ",
      "เสารี": "เสารี", "โสโร": "โสโร", "โสระ": "โสระ",
      "อสุรินทร์": "อสุรินทร์", "ราหู": "ราหู"
    }
  },
  en: {
    ...
    yam_names: {
      "สุริชะ": "Suricha (Sun)", "สุริยะ": "Suriya (Sun)", "ระวิ": "Rawi (Sun)",
      "จันเทา": "Chanthau (Moon)", "ศะศิ": "Sasi (Moon)", "คะศิ": "Khasi (Moon)",
      "ภุมมะ": "Bhumma (Mars)", "ภุมโม": "Bhummo (Mars)", "ภุมรา": "Bhumra (Mars)",
      "พุธะ": "Phutha (Mercury)", "พุทธะ": "Phutha (Mercury)", "พุโธ": "Phutho (Mercury)", "พุทโธ": "Phutho (Mercury)", "ทิวา": "Thiwa (Mercury)", "วาณี": "Wanee (Mercury)",
      "ครู": "Guru (Jupiter)", "ชีโว": "Cheewo (Jupiter)", "คุรุ": "Khuru (Jupiter)",
      "ศุกระ": "Sukra (Venus)", "ศุโกร": "Shukro (Venus)", "ภัสสะ": "Phatsa (Venus)",
      "เสารี": "Sauree (Saturn)", "โสโร": "Soro (Saturn)", "โสระ": "Sora (Saturn)",
      "อสุรินทร์": "Asurin (Rahu)", "ราหู": "Rahu"
    }
  },
  zh: {
    title: "当前时辰",
    ...
    inauspicious: "凶",
    yam_names: {
      "สุริชะ": "日华 (Suricha)", "สุริยะ": "日华 (Suriya)", "ระวิ": "烈阳 (Rawi)",
      "จันเทา": "皎月 (Chanthau)", "ศะศิ": "月魄 (Sasi)", "คะศิ": "月魄 (Khasi)",
      "ภุมมะ": "荧惑 (Bhumma)", "ภุมโม": "火曜 (Bhummo)", "ภุมรา": "战神 (Bhumra)",
      "พุธะ": "水德 (Phutha)", "พุทธะ": "水德 (Phutha)", "พุโธ": "水曜 (Phutho)", "พุทโธ": "水曜 (Phutho)", "ทิวา": "辰星 (Thiwa)", "วาณี": "水星 (Wanee)",
      "ครู": "木德 (Guru)", "ชีโว": "岁星 (Cheewo)", "คุรุ": "木星 (Khuru)",
      "ศุกระ": "太白 (Sukra)", "ศุโกร": "金曜 (Shukro)", "ภัสสะ": "金星 (Phatsa)",
      "เสารี": "土星 (Sauree)", "โสโร": "土曜 (Soro)", "โสระ": "镇星 (Sora)",
      "อสุรินทร์": "蚀神 (Asurin)", "ราหู": "罗睺 (Rahu)"
    }
  },
} as const;
