...
const styles = StyleSheet.create({
  ...
  cellDir: { color: '#8A8070', fontSize: 8, fontWeight: 'bold', textTransform: 'uppercase' },
  ...
  sawaiLabel: { color: '#8A8070', fontSize: 10, fontWeight: 'bold', marginBottom: 4 },
  ...
  dirSub: { color: '#8A8070', fontSize: 11 },
  dirBadge: {
    borderWidth: 1,
